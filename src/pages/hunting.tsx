		...
		<>
			...
			<div className="p-4">
				...
				<ul className="p-4 py-2 mx-8 -my-2 text-xl list-disc">
					...
					<li>Campsite method : still slow, but probability is can be much more manipulated, making it much easier</li>
				</ul>
				<p className="p-4 text-xl">
					...
					which means at least 35 in game weeks. With time traveling, this means at least 100 time jumps, so more or
					less 20 hours. Without TT, this means at least .... 35 real life weeks ! Your mileage may vary.
				</p>
				<section>
					...
					<p className="p-4 text-xl">
						...
						sale. If you need to get rid of a current villager beforehand, you'll need to ignore them fo a while. For
						more information on how to kick a villager, you can watch{' '}
				...
				<section>
					...
					<ul className="p-4 py-2 mx-8 -my-2 text-xl list-disc">
						<li>
							Any villager that spawns in the campsite will NOT respawn there twice before all the same personality
					...
					<p className="p-4 text-xl">
						...
						40 campsite. I for example, got Julian after 35 campsites. My soul is dead after so much time travel, BUT I
					...
					<p className="p-4 text-xl">
						...
						data loaded on the website), Raymond is at 0.52% while all peppy villagers is at 0.12%.
					</p>
